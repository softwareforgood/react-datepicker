...
}(this, (function (React,PropTypes,classnames,onClickOutside,moment$1,reactPopper) { 'use strict';
...
var _reactTransformHmr2$3 = _reactTransformHmr({
  filename: '/Users/evanheisler/dev/contributing/react-datepicker/src/year_dropdown_options.jsx',
...
function newDate(point) {
  return moment$1(point);
}

function newDateWithOffset(utcOffset) {
  return moment$1().utc().utcOffset(utcOffset);
}
...
function parseDate(value, _ref) {
  ...
  var m = moment$1(value, dateFormat, locale || moment$1.locale(), true);
...
function isMoment(date) {
  return moment$1.isMoment(date);
}

function isDate(date) {
  return moment$1.isDate(date);
}
...
function safeDateFormat(date, _ref2) {
  ...
  return date && date.clone().locale(locale || moment$1.locale()).format(Array.isArray(dateFormat) ? dateFormat[0] : dateFormat) || '';
}
...
function localizeDate(date, locale) {
  return date.clone().locale(locale || moment$1.locale());
}
...
function getLocaleDataForLocale(locale) {
  return moment$1.localeData(locale);
}
...
function isTimeInDisabledRange(time, _ref5) {
  ...
  var base = moment$1().hours(0).minutes(0).seconds(0);
...
function getEffectiveMinDate(_ref8) {
  ...
  if (includeDates && minDate) {
    return moment$1.min(includeDates.filter(function (includeDate) {
      return minDate.isSameOrBefore(includeDate, 'day');
    }));
  } else if (includeDates) {
    return moment$1.min(includeDates);
  } else {
    return minDate;
  }
}
...
function getEffectiveMaxDate(_ref9) {
  ...
  if (includeDates && maxDate) {
    return moment$1.max(includeDates.filter(function (includeDate) {
      return maxDate.isSameOrAfter(includeDate, 'day');
    }));
  } else if (includeDates) {
    return moment$1.max(includeDates);
  } else {
    return maxDate;
  }
}
...
var _reactTransformHmr2$2 = _reactTransformHmr({
  filename: '/Users/evanheisler/dev/contributing/react-datepicker/src/year_dropdown.jsx',
...
var _reactTransformHmr2$5 = _reactTransformHmr({
  filename: '/Users/evanheisler/dev/contributing/react-datepicker/src/month_dropdown_options.jsx',
...
var _reactTransformHmr2$4 = _reactTransformHmr({
  filename: '/Users/evanheisler/dev/contributing/react-datepicker/src/month_dropdown.jsx',
...
var _reactTransformHmr2$8 = _reactTransformHmr({
  filename: '/Users/evanheisler/dev/contributing/react-datepicker/src/day.jsx',
...
var Day = _wrapComponent$8('Day')((_temp2$5 = _class$8 = function (_React$Component) {
  ...
  Day.prototype.render = function render() {
    return React.createElement(
      ...
      this.props.dateData && React.createElement(
        'div',
        { className: 'date-data' },
        this.props.dateData[moment(this.props.day).format('YYYY-MM-DD')]
      )
    );
  };
...
var _reactTransformHmr2$9 = _reactTransformHmr({
  filename: '/Users/evanheisler/dev/contributing/react-datepicker/src/week_number.jsx',
...
var _reactTransformHmr2$7 = _reactTransformHmr({
  filename: '/Users/evanheisler/dev/contributing/react-datepicker/src/week.jsx',
...
var _reactTransformHmr2$6 = _reactTransformHmr({
  filename: '/Users/evanheisler/dev/contributing/react-datepicker/src/month.jsx',
...
var _reactTransformHmr2$10 = _reactTransformHmr({
  filename: '/Users/evanheisler/dev/contributing/react-datepicker/src/time.jsx',
...
var _reactTransformHmr2$1 = _reactTransformHmr({
  filename: '/Users/evanheisler/dev/contributing/react-datepicker/src/calendar.jsx',
...
var _reactTransformHmr2$11 = _reactTransformHmr({
  filename: '/Users/evanheisler/dev/contributing/react-datepicker/src/popper_component.jsx',
...
var _reactTransformHmr2 = _reactTransformHmr({
  filename: '/Users/evanheisler/dev/contributing/react-datepicker/src/index.jsx',
